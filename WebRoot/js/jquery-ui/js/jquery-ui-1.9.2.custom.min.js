...
(function(t, e) {
	...
	t.position = {
			...
			e = t.extend({}, e);
			var n, d, f, m, g, v = t(e.of),
				_ = t.position.getWithinInfo(e.within),
				b = t.position.getScrollInfo(_),
				y = v[0],
				w = (e.collision || "flip").split(" "),
				x = {};
			return 9 === y.nodeType ? (d = v.width(), f = v.height(), m = {
				top: 0,
				left: 0
			}) : t.isWindow(y) ? (d = v.width(), f = v.height(), m = {
				top: v.scrollTop(),
				left: v.scrollLeft()
			}) : y.preventDefault ? (e.at = "left top", d = f = 0, m = {
				top: y.pageY,
				left: y.pageX
			}) : (d = v.outerWidth(), f = v.outerHeight(), m = v.offset()), g = t.extend({}, m), t.each(["my", "at"], function() {
				var t, i, s = (e[this] || "").split(" ");
				1 === s.length && (s = h.test(s[0]) ? s.concat(["center"]) : l.test(s[0]) ? ["center"].concat(s) : ["center", "center"]), s[0] = h.test(s[0]) ? s[0] : "center", s[1] = l.test(s[1]) ? s[1] : "center", t = c.exec(s[0]), i = c.exec(s[1]), x[this] = [t ? t[0] : 0, i ? i[0] : 0], e[this] = [u.exec(s[0])[0], u.exec(s[1])[0]]
			}), 1 === w.length && (w[1] = w[0]), "right" === e.at[0] ? g.left += d : "center" === e.at[0] && (g.left += d / 2), "bottom" === e.at[1] ? g.top += f : "center" === e.at[1] && (g.top += f / 2), n = i(x.at, d, f), g.left += n[0], g.top += n[1], this.each(function() {
				var h, l, c = t(this),
					u = c.outerWidth(),
					p = c.outerHeight(),
					y = s(this, "marginLeft"),
					k = s(this, "marginTop"),
					C = u + y + s(this, "marginRight") + b.width,
					D = p + k + s(this, "marginBottom") + b.height,
					T = t.extend({}, g),
					M = i(x.my, c.outerWidth(), c.outerHeight());
				"right" === e.my[0] ? T.left -= u : "center" === e.my[0] && (T.left -= u / 2), "bottom" === e.my[1] ? T.top -= p : "center" === e.my[1] && (T.top -= p / 2), T.left += M[0], T.top += M[1], t.support.offsetFractions || (T.left = r(T.left), T.top = r(T.top)), h = {
					marginLeft: y,
					marginTop: k
				}, t.each(["left", "top"], function(i, s) {
					t.ui.position[w[i]] && t.ui.position[w[i]][s](T, {
						targetWidth: d,
						targetHeight: f,
						elemWidth: u,
						elemHeight: p,
					...
					u > d && d > a(i + s) && (h.horizontal = "center"), p > f && f > a(n + r) && (h.vertical = "middle"), h.important = o(a(i), a(s)) > o(a(n), a(r)) ? "horizontal" : "vertical", e.using.call(this, t, h)
				}), c.offset(t.extend(T, {
					using: l
				}))
			})
			...
			flip: {
				...
				top: function(t, e) {
					var i, s, n = e.within,
						...
						m = -2 * e.offset[1];
					0 > c ? (s = t.top + p + f + m + e.collisionHeight - r - o, t.top + p + f + m > c && (0 > s || a(c) > s) && (t.top += p + f + m)) : u > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + m - h, t.top + p + f + m > u && (i > 0 || u > a(i)) && (t.top += p + f + m))
				}
			},
			flipfit: {
				left: function() {
	...
	t.widget("ui.draggable", t.ui.mouse, {
		...
		_generatePosition: function(e) {
			...
			if (this.originalPosition) {
				...
				if (i.grid) {
					var l = i.grid[1] ? this.originalPageY + Math.round((a - this.originalPageY) / i.grid[1]) * i.grid[1] : this.originalPageY;
					a = r ? l - this.offset.click.top < r[1] || l - this.offset.click.top > r[3] ? l - this.offset.click.top < r[1] ? l + i.grid[1] : l - i.grid[1] : l : l;
					var u = i.grid[0] ? this.originalPageX + Math.round((o - this.originalPageX) / i.grid[0]) * i.grid[0] : this.originalPageX;
					o = r ? u - this.offset.click.left < r[0] || u - this.offset.click.left > r[2] ? u - this.offset.click.left < r[0] ? u + i.grid[0] : u - i.grid[0] : u : u
				}
			}
			return {
		...
		drag: function(e, i) {
			for (var s = t(this).data("draggable"), n = s.options, o = n.snapTolerance, a = i.offset.left, r = a + s.helperProportions.width, h = i.offset.top, l = h + s.helperProportions.height, u = s.snapElements.length - 1; u >= 0; u--) {
				var c = s.snapElements[u].left,
					d = c + s.snapElements[u].width,
					p = s.snapElements[u].top,
					f = p + s.snapElements[u].height;
				if (a > c - o && d + o > a && h > p - o && f + o > h || a > c - o && d + o > a && l > p - o && f + o > l || r > c - o && d + o > r && h > p - o && f + o > h || r > c - o && d + o > r && l > p - o && f + o > l) {
					if ("inner" != n.snapMode) {
						var m = o >= Math.abs(p - l),
							g = o >= Math.abs(f - h),
							v = o >= Math.abs(c - r),
							_ = o >= Math.abs(d - a);
					...
					}!s.snapElements[u].snapping && (m || g || v || _ || b) && s.options.snap.snap && s.options.snap.snap.call(s.element, e, t.extend(s._uiHash(), {
						snapItem: s.snapElements[u].item
					})), s.snapElements[u].snapping = m || g || v || _ || b
				} else s.snapElements[u].snapping && s.options.snap.release && s.options.snap.release.call(s.element, e, t.extend(s._uiHash(), {
					snapItem: s.snapElements[u].item
...
(function(t) {
	t.widget("ui.droppable", {
		...
		switch (s) {
			case "fit":
				return n >= h && l >= o && a >= u && c >= r;
			case "intersect":
				return n + e.helperProportions.width / 2 > h && l > o - e.helperProportions.width / 2 && a + e.helperProportions.height / 2 > u && c > r - e.helperProportions.height / 2;
			case "pointer":
				var d = (e.positionAbs || e.position.absolute).left + (e.clickOffset || e.offset.click).left,
					...
					f = t.ui.isOver(p, d, u, h, i.proportions.height, i.proportions.width);
				return f;
			case "touch":
				return (a >= u && c >= a || r >= u && c >= r || u > a && r > c) && (n >= h && l >= n || o >= h && l >= o || h > n && o > l);
			default:
				return !1
		}
	}, t.ui.ddmanager = {
...
(function(t) {
	t.widget("ui.resizable", t.ui.mouse, {
		...
		_mouseStart: function(i) {
			...
			return t("body").css("cursor", "auto" == h ? this.axis + "-resize" : h), o.addClass("ui-resizable-resizing"), this._propagate("start", i), !0
		},
		...
		_respectSize: function(t, e) {
			...
			r && (t.width = s.minWidth), h && (t.height = s.minHeight), o && (t.width = s.maxWidth), a && (t.height = s.maxHeight);
			var l = this.originalPosition.left + this.originalSize.width,
				u = this.position.top + this.size.height,
				c = /sw|nw|w/.test(n),
				d = /nw|ne|n/.test(n);
			r && c && (t.left = l - s.minWidth), o && c && (t.left = l - s.maxWidth), h && d && (t.top = u - s.minHeight), a && d && (t.top = u - s.maxHeight);
		...
		start: function() {
			...
			if (a)
				if (i.containerElement = t(a), /document/.test(o) || o == document) i.containerOffset = {
					left: 0,
					top: 0
				}, i.containerPosition = {
					left: 0,
					...
					var l = i.containerOffset,
						...
						d = t.ui.hasScroll(a, "left") ? a.scrollWidth : c,
						p = t.ui.hasScroll(a) ? a.scrollHeight : u;
					i.parentData = {
						element: a,
						left: l.left,
						top: l.top,
		...
		resize: function(e) {
			...
			c && d && (l -= i.parentData.left), l + i.size.width >= i.parentData.width && (i.size.width = i.parentData.width - l, a && (i.size.height = i.size.width / i.aspectRatio)), u + i.size.height >= i.parentData.height && (i.size.height = i.parentData.height - u, a && (i.size.width = i.size.height * i.aspectRatio))
		},
		stop: function() {
			var e = t(this).data("resizable"),
				i = e.options,
		...
		resize: function(e) {
			...
			var h = Math.round((n.width - o.width) / (s.grid[0] || 1)) * (s.grid[0] || 1),
				l = Math.round((n.height - o.height) / (s.grid[1] || 1)) * (s.grid[1] || 1);
			/^(se|s|e)$/.test(r) ? (i.size.width = o.width + h, i.size.height = o.height + l) : /^(ne)$/.test(r) ? (i.size.width = o.width + h, i.size.height = o.height + l, i.position.top = a.top - l) : /^(sw)$/.test(r) ? (i.size.width = o.width + h, i.size.height = o.height + l, i.position.left = a.left - h) : (i.size.width = o.width + h, i.size.height = o.height + l, i.position.top = a.top - l, i.position.left = a.left - h)
		}
	});
	var e = function(t) {
	...
	t.widget("ui.sortable", t.ui.mouse, {
		...
		_refreshItems: function(e) {
			...
			for (var o = s.length - 1; o >= 0; o--)
				for (var l = s[o][1], u = s[o][0], r = 0, c = u.length; c > r; r++) {
					var d = t(u[r]);
		...
		_contactContainers: function(e) {
			...
			if (i)
				if (1 === this.containers.length) this.containers[s]._trigger("over", e, this._uiHash(this)), this.containers[s].containerCache.over = 1;
					...
					for (var o = 1e4, a = null, r = this.containers[s].floating ? "left" : "top", h = this.containers[s].floating ? "width" : "height", l = this.positionAbs[r] + this.offset.click[r], u = this.items.length - 1; u >= 0; u--)
						if (t.contains(this.containers[s].element[0], this.items[u].item[0]) && this.items[u].item[0] != this.currentItem[0]) {
							var c = this.items[u].item.offset()[r],
								d = !1;
							Math.abs(c - l) > Math.abs(c + this.items[u][h] - l) && (d = !0, c += this.items[u][h]), o > Math.abs(c - l) && (o = Math.abs(c - l), a = this.items[u], this.direction = d ? "up" : "down")
						}
...
(function(t) {
	...
	i.height = i.paddingTop = i.paddingBottom = i.borderTopWidth = i.borderBottomWidth = "hide", s.height = s.paddingTop = s.paddingBottom = s.borderTopWidth = s.borderBottomWidth = "show", t.widget("ui.accordion", {
		...
		_animate: function(t, e, n) {
			...
			return "number" == typeof d && (r = d), "string" == typeof d && (a = d), a = a || d.easing || c.easing, r = r || d.duration || c.duration, e.length ? t.length ? (o = t.show().outerHeight(), e.animate(i, {
				duration: r,
				easing: a,
				step: function(t, e) {
					e.now = Math.round(t)
...
(function($, undefined) {
	...
	$.extend(Datepicker.prototype, {
			...
			if (t = t.target || t, "input" != t.nodeName.toLowerCase() && (t = $("input", t.parentNode)[0]), !$.datepicker._isDisabledDatepicker(t) && $.datepicker._lastInput != t) {
				...
				if (s !== !1) {
					...
					if ($.datepicker._pos = null, e.dpDiv.empty(), e.dpDiv.css({
						...
						e.dpDiv.zIndex($(t).zIndex() + 1), $.datepicker._datepickerShowing = !0, $.effects && ($.effects.effect[a] || $.effects[a]) ? e.dpDiv.show(a, $.datepicker._get(e, "showOptions"), r, h) : e.dpDiv[a || "show"](a ? r : null, h), a && r || h(), e.input.is(":visible") && !e.input.is(":disabled") && e.input.focus(), $.datepicker._curInst = e
					}
				}
			}
		},
		...
		parseDate: function(t, e, i) {
			...
			for (var n = (i ? i.dayNamesShort : null) || this._defaults.dayNamesShort, o = (i ? i.dayNames : null) || this._defaults.dayNames, a = (i ? i.monthNamesShort : null) || this._defaults.monthNamesShort, r = (i ? i.monthNames : null) || this._defaults.monthNames, h = -1, l = -1, u = -1, c = -1, d = !1, p = function(e) {
					...
					if ($.each(n, function(t, i) {
							var s = i[1];
							return e.substr(v, s.length).toLowerCase() == s.toLowerCase() ? (o = i[0], v += s.length, !1) : undefined
						}), -1 != o) return o + 1;
					throw "Unknown name at position " + v
				}, g = function() {
					if (e.charAt(v) != t.charAt(_)) throw "Unexpected literal at position " + v;
					v++
				}, v = 0, _ = 0; t.length > _; _++)
			...
			if (-1 == h ? h = (new Date).getFullYear() : 100 > h && (h += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (s >= h ? 0 : -100)), c > -1)
				for (l = 1, u = c;;) {
		...
		formatDate: function(t, e, i) {
			...
			if (e)
				for (var d = 0; t.length > d; d++)
					if (c) "'" != t.charAt(d) || r("'") ? u += t.charAt(d) : c = !1;
						...
						case "m":
							...
							break;
						case "M":
							u += l("M", e.getMonth(), o, a);
							break;
						case "y":
							u += r("y") ? e.getFullYear() : (10 > e.getYear() % 100 ? "0" : "") + e.getYear() % 100;
							break;
						case "@":
							u += e.getTime();
							break;
		...
		_determineDate: function(t, e, i) {
			var s = function(t) {
				...
				n = function(e) {
					...
					for (var s = (e.toLowerCase().match(/^c/) ? $.datepicker._getDate(t) : null) || new Date, n = s.getFullYear(), o = s.getMonth(), a = s.getDate(), r = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, h = r.exec(e); h;) {
						switch (h[2] || "d") {
							case "d":
							case "D":
								a += parseInt(h[1], 10);
							...
							case "m":
							case "M":
								o += parseInt(h[1], 10), a = Math.min(a, $.datepicker._getDaysInMonth(n, o));
								break;
							case "y":
							case "Y":
								n += parseInt(h[1], 10), a = Math.min(a, $.datepicker._getDaysInMonth(n, o))
						}
						h = r.exec(e)
					}
		...
		_generateHTML: function(t) {
			...
			g = o ? this.formatDate(g, this._daylightSavingAdjust(new Date(f, p - h, 1)), this._getFormatConfig(t)) : g;
			...
			_ = o ? this.formatDate(_, this._daylightSavingAdjust(new Date(f, p + h, 1)), this._getFormatConfig(t)) : _;
			...
			var x = t.inline ? "" : '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" data-handler="hide" data-event="click">' + this._get(t, "closeText") + "</button>",
				k = s ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (i ? x : "") + (this._isInRange(t, w) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" data-handler="today" data-event="click">' + y + "</button>" : "") + (i ? "" : x) + "</div>" : "",
			...
			for (var H = this._getDefaultDate(t), z = "", O = 0; a[0] > O; O++) {
				var E = "";
				this.maxRows = 4;
				for (var W = 0; a[1] > W; W++) {
					var F = this._daylightSavingAdjust(new Date(f, p, t.selectedDay)),
						...
						R = "";
					if (l) {
						if (R += '<div class="ui-datepicker-group', a[1] > 1) switch (W) {
							case 0:
					...
					R += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + L + '">' + (/all|left/.test(L) && 0 == O ? i ? b : v : "") + (/all|right/.test(L) && 0 == O ? i ? v : b : "") + this._generateMonthYearHeader(t, p, f, c, d, O > 0 || W > 0, S, I) + '</div><table class="ui-datepicker-calendar"><thead>' + "<tr>";
					for (var j = D ? '<th class="ui-datepicker-week-col">' + this._get(t, "weekHeader") + "</th>" : "", Y = 0; 7 > Y; Y++) {
						var B = (Y + C) % 7;
						j += "<th" + ((Y + C + 6) % 7 >= 5 ? ' class="ui-datepicker-week-end"' : "") + ">" + '<span title="' + T[B] + '">' + M[B] + "</span></th>"
					}
					R += j + "</tr></thead><tbody>";
		...
		_generateMonthYearHeader: function(t, e, i, s, n, o, a, r) {
			var h = this._get(t, "changeMonth"),
				...
				d = "";
			if (o || !h) d += '<span class="ui-datepicker-month">' + a[e] + "</span>";
			else {
				var p = s && s.getFullYear() == i,
					f = n && n.getFullYear() == i;
				d += '<select class="ui-datepicker-month" data-handler="selectMonth" data-event="change">';
				for (var m = 0; 12 > m; m++)(!p || m >= s.getMonth()) && (!f || n.getMonth() >= m) && (d += '<option value="' + m + '"' + (m == e ? ' selected="selected"' : "") + ">" + r[m] + "</option>");
				d += "</select>"
			}
			if (u || (c += d + (!o && h && l ? "" : "&#xa0;")), !t.yearshtml)
				if (t.yearshtml = "", o || !l) c += '<span class="ui-datepicker-year">' + i + "</span>";
				else {
			...
			return c += this._get(t, "yearSuffix"), u && (c += (!o && h && l ? "" : "&#xa0;") + d), c += "</div>"
		},
...
(function(t, e) {
	...
	t.widget("ui.dialog", {
		...
		_create: function() {
			...
			var s, n, o, a, r, h = this,
				l = this.options,
				u = l.title || "&#160;";
			s = (this.uiDialog = t("<div>")).addClass(i + l.dialogClass).css({
				display: "none",
				outline: 0,
				zIndex: l.zIndex
			}).attr("tabIndex", -1).keydown(function(e) {
				l.closeOnEscape && !e.isDefaultPrevented() && e.keyCode && e.keyCode === t.ui.keyCode.ESCAPE && (h.close(e), e.preventDefault())
				...
				t.preventDefault(), h.close(t)
			}).appendTo(n), (this.uiDialogTitlebarCloseText = t("<span>")).addClass("ui-icon ui-icon-closethick").text(l.closeText).appendTo(o), a = t("<span>").uniqueId().addClass("ui-dialog-title").html(u).prependTo(n), r = (this.uiDialogButtonPane = t("<div>")).addClass("ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"), (this.uiButtonSet = t("<div>")).addClass("ui-dialog-buttonset").appendTo(r), s.attr({
				role: "dialog",
				"aria-labelledby": a.attr("id")
			}), n.find("*").add(n).disableSelection(), this._hoverable(o), this._focusable(o), l.draggable && t.fn.draggable && this._makeDraggable(), l.resizable && t.fn.resizable && this._makeResizable(), this._createButtons(l.buttons), this._isOpen = !1, t.fn.bgiframe && s.bgiframe(), this._on(s, {
				keydown: function(i) {
...
(function(t) {
	...
	t.widget("ui.slider", t.ui.mouse, {
		...
		_mouseCapture: function(e) {
			...
			}), c.range === !0 && this.values(1) === c.min && (a += 1, o = t(this.handles[a])), r = this._start(e, a), r === !1 ? !1 : (this._mouseSliding = !0, this._handleIndex = a, o.addClass("ui-state-active").focus(), h = o.offset(), l = !t(e.target).parents().andSelf().is(".ui-slider-handle"), this._clickOffset = l ? {
				left: 0,
				top: 0
			} : {
	...
	t.widget("ui.tabs", {
		...
		_processTabs: function() {
			...
			this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role", "tablist"), this.tabs = this.tablist.find("> li:has(a[href])").addClass("ui-state-default ui-corner-top").attr({
				...
				s(n) ? (o = n.hash, a = e.element.find(e._sanitizeSelector(o))) : (r = e._tabId(l), o = "#" + r, a = e.element.find(o), a.length || (a = e._createPanel(r), a.insertAfter(e.panels[i - 1] || e.tablist)), a.attr("aria-live", "polite")), a.length && (e.panels = e.panels.add(a)), u && l.data("ui-tabs-aria-controls", u), l.attr({
		...
		_open: function(i, s, n) {
			...
			if (n) {
				...
				s.is("[title]") && (i && "mouseover" === i.type ? s.attr("title", "") : s.removeAttr("title")), a = this._tooltip(s), e(s, a.attr("id")), a.find(".ui-tooltip-content").html(n), this.options.track && i && /^mouse/.test(i.type) ? (this._on(this.document, {
					...
					of: s
				}, this.options.position)), a.hide(), this._show(a, this.options.show), this.options.show && this.options.show.delay && (h = setInterval(function() {
	...
	t.effects = {
		...
		function(e, i) {
			...
			function n(t) {
				var s = u(),
					n = s._rgba = [];
				return t = t.toLowerCase(), m(l, function(e, o) {
					var a, r = o.re.exec(t),
						h = r && o.parse(r),
						l = o.space || "rgba";
					return h ? (a = s[l](h), s[c[l].cache] = a[c[l].cache], n = s._rgba = a._rgba, !1) : i
			...
			var a, r = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor".split(" "),
				...
				f = e("<p>")[0],
				m = e.each;
			f.style.cssText = "background-color:rgba(1,1,1,.5)", p.rgba = f.style.backgroundColor.indexOf("rgba") > -1, m(c, function(t, e) {
				...
				parse: function(o, r, h, l) {
					if (o === i) return this._rgba = [null, null, null, null], this;
					(o.jquery || o.nodeType) && (o = e(o).css(r), r = i);
					var d = this,
						p = e.type(o),
						f = this._rgba = [];
					return r !== i && (o = [o, r, h, l], p = "array"), "string" === p ? this.parse(n(o) || a._default) : "array" === p ? (m(c.rgba.props, function(t, e) {
						f[e.idx] = s(o[e.idx], e)
					}), this) : "object" === p ? (o instanceof u ? m(c, function(t, e) {
				...
				is: function(t) {
					var e = u(t),
						s = !0,
						n = this;
					return m(c, function(t, o) {
						var a, r = e[o.cache];
						return r && (a = n[o.cache] || o.to && o.to(n._rgba) || [], m(o.props, function(t, e) {
				...
				transition: function(t, e) {
					var i = u(t),
						...
						h = r.slice();
					return i = i[o.cache], m(o.props, function(t, n) {
						var o = n.idx,
							a = r[o],
							l = i[o],
							u = d[n.type] || {};
						null !== l && (null === a ? h[o] = l : (u.mod && (l - a > u.mod / 2 ? a += u.mod : a - l > u.mod / 2 && (a -= u.mod)), h[o] = s((l - a) * e + a, n)))
					}), this[n](h)
				},
				blend: function(t) {
				...
				var e, i, s = t[0] / 255,
					...
					u = r + h,
					c = .5 * u;
				return e = h === r ? 0 : s === r ? 60 * (n - o) / l + 360 : n === r ? 60 * (o - s) / l + 120 : 60 * (s - n) / l + 240, i = 0 === c || 1 === c ? c : .5 >= c ? l / u : l / (2 - u), [Math.round(e) % 360, i, c, null == a ? 1 : a]
				...
				u.fn[t] = function(t) {
					...
					var n, h = e.type(t),
						c = "array" === h || "object" === h ? t : arguments,
						d = this[a].slice();
					return m(o, function(t, e) {
						var i = c["object" === h ? t : e.idx];
						null == i && (i = d[e.idx]), d[e.idx] = s(i, e)
					}), l ? (n = u(l(d)), n[a] = d, n) : u(d)
				}, m(o, function(i, s) {
					u.fn[i] || (u.fn[i] = function(n) {
						var o, a = e.type(n),
							...
							l = this[r](),
							u = l[s.idx];
						return "undefined" === a ? u : ("function" === a && (n = n.call(this, u), a = e.type(n)), null == n && s.empty ? this : ("string" === a && (o = h.exec(n), o && (n = u + parseFloat(o[2]) * ("+" === o[1] ? 1 : -1))), l[s.idx] = n, this[r](l)))
					})
				})
			}), m(r, function(t, i) {
				e.cssHooks[i] = {
			...
			t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(e, i) {
				...
				toggleClass: function(i, s, n, o, a) {
					return "boolean" == typeof s || s === e ? n ? t.effects.animateClass.call(this, s ? {
						...
						remove: i
					}, n, o, a) : this._toggleClass(i, s) : t.effects.animateClass.call(this, {
						toggle: i
					}, s, n, o)
				},
			...
			t.extend(t.effects, {
				...
				effect: function() {
					...
					var s = n.apply(this, arguments),
						...
						h = !r && i && t.effects[s.effect];
					return t.fx.off || !r && !h ? o ? this[o](s.duration, s.complete) : this.each(function() {
						s.complete && s.complete.call(this)
					}) : r ? a === !1 ? this.each(e) : this.queue(a || "fx", e) : h.call(this, {
						options: s,
						duration: s.duration,
						callback: s.complete,
						mode: s.mode
...
(function(t) {
	...
	t.effects.effect.blind = function(s, n) {
		var o, a, r, h = t(this),
			...
			u = t.effects.setMode(h, s.mode || "hide"),
			c = s.direction || "up",
			d = e.test(c),
			p = d ? "height" : "width",
			f = d ? "top" : "left",
		...
		h.parent().is(".ui-effects-wrapper") ? t.effects.save(h.parent(), l) : t.effects.save(h, l), h.show(), o = t.effects.createWrapper(h).css({
			overflow: "hidden"
		}), a = o[p](), r = parseFloat(o.css(f)) || 0, g[p] = v ? a : 0, m || (h.css(d ? "bottom" : "right", 0).css(d ? "top" : "left", "auto").css({
			position: "absolute"
			...
			queue: !1,
			complete: function() {
				"hide" === u && h.hide(), t.effects.restore(h, l), t.effects.removeWrapper(h), n()
			}
		})
	}
})(jQuery);
