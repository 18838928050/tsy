...
<body>
	...
	<div class="rt_content">
		<div class="page_title">
			<h2 class="fl">新闻头条</h2>
			<a id="opener" href="news/ToListPage" class="fr top_rt_btn add_icon">刷新</a>
		</div>
		...
		<div id="wrap">
			<c:forEach items="${newslist}" var="bean" varStatus="status">
				<div class="box">
					<div class="info">
						<div class="pic">
							<img src="${bean.thumbnail_pic_s }" onclick="jiazaiUrl('${bean.url}','${status.index }')">
						</div>
						<div class="title">
							<a href="#">${bean.title }</a>
						</div>
	...
	<c:forEach items="${newslist}" var="a">
		...
		<input type="hidden" value="${a.thumbnail_pic_s03 }" name="thumbnail_pic_s03" />
		<input type="hidden" value="${a.uniquekey }" name="uniquekey" />
		<input type="hidden" value="${a.thumbnail_pic_s02 }" name="thumbnail_pic_s02" />
		<input type="hidden" value="${a.author_name }" name="author_name" />
		<input type="hidden" value="${a.thumbnail_pic_s }" name="thumbnail_pic_s" />
